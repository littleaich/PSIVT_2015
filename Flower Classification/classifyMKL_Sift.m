...
% test SIFT features from Oxford-102 flower dataset (PSIVT_2015). It tests
% the accuracy of the system using only SIFT features and multiple kernel
% learning approach downloaded from this link
% http://leitang.net/code/mkl-multiple-label/README.txt
% The file hierarchy for SIFT features extraction and testing using 
% multiple kernel learning (Oxford-102 dataset, PSIVT_2015) is listed as 
% follows: (1) extractSiftFeatures.m, (2) makeSiftDesMat.m, 
